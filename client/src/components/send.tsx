...
export function Send() {
  ...
  const [victionAddr, setvictionAddr] = useState<string>(
  ...
  const debouncedAddr = useDebounce(victionAddr, 500);
  ...
  return (
    <div style={{ paddingTop: '1rem' }}>
      <p>
      VIC will be sent to a secret blockchain account that will hold the VIC temporarily.
